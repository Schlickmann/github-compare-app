  ...
  render() {
    return (
      <Container>
        ...
        <span style={{ fontSize: 18, color: '#fff', marginTop: 15 }}>Compare repositories from Github. You are able to see how many <strong>stars, forks and issues</strong> a specific repo has.<br /></span>
        <Form
